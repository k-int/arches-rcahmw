...
def delete_admin_area_unneeded_imports(apps, schema_editor):

    ConceptModel = apps.get_model("models", "Concept")
    ...
    for concept_uuid in concept_uuids:
        try:
            ConceptModel.objects.get(conceptid=concept_uuid).delete()
        except:
            print(concept_uuid)
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(delete_admin_area_unneeded_imports),
    ]
