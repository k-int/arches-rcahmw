"""
Django settings for rcahmw project.
"""
...
DATATYPE_LOCATIONS.append("rcahmw.datatypes")
FUNCTION_LOCATIONS.append("rcahmw.functions")
ETL_MODULE_LOCATIONS.append("rcahmw.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("rcahmw.search_components")
...
SECRET_KEY = "52&ay9&&_s97_@*57s-o3^8o&37d$ru-##v@xg+_1z(ejvuc*%"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "rcahmw.urls"
...
ELASTICSEARCH_PREFIX = "rcahmw"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'rcahmw.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = "rcahmw.wsgi.application"
