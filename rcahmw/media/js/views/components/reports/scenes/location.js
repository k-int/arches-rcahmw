    ...
    return ko.components.register('views/components/reports/scenes/location', {
        viewModel: function (params) {
            ...
            self.geometryScale = {
                ...
                kmsq: ko.observable(),
                mapsheet: ko.observable(),
                ngrAccuracy: ko.observable(),
                ngrSource: ko.observable(),
            };
            ...
            if (params?.compiled) {
                ...
                if (geometryNode) {
                    ...
                    self.geometryScale.kmsq(self.getNodeValue(geometryNode, 'KMSQ'))
                    self.geometryScale.mapsheet(self.getNodeValue(geometryNode, 'mapsheet'))
                    self.geometryScale.ngrSource(self.getNodeValue(geometryNode, 'NGR Source'))
                    self.geometryScale.ngrAccuracy(self.getNodeValue(geometryNode, 'NGR Accuracy'))
